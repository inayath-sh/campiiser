...
```
:::note[Windows]
For windows you might need to select python interpreter manually. To do this, press <Badge text="ctrl + shift + p" variant="tip" size="small" /> and type `Python: Select Interpreter` and select the anaconda interpreter from the list. 
If you do not see this option ensure the python extension is installed in VS Code.
